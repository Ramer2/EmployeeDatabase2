...
namespace EmployeeManager.Services.Migrations
{
    ...
    public partial class EmployeeDbMigraton : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__DeviceTy__737584F6664D5C37",
                table: "DeviceType",
                column: "Name",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Person__45809E71849D47DF",
                table: "Person",
                column: "PassportNumber",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "UQ__Person__85FB4E38292E2776",
                table: "Person",
                column: "PhoneNumber",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "UQ__Person__A9D1053478862ECE",
                table: "Person",
                column: "Email",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "UQ__Position__737584F6AC0B2427",
                table: "Position",
                column: "Name",
                unique: true);
        }
